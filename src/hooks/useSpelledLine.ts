 ...
 */
export function useSpelledLine(groups: CellGroup[], intervalMs: number, windowSize: number = 20): UseSpelledLine {
  ...
  const visibleGroupIndexes = Array.from(new Set(dotGroup.slice(windowStart)))
